...
<head>
	...
	<title>VERONICA AGUILAR|BEAUTY STUDIO</title>
...
<body>
					...
					<div class="nav-inner">
						<nav class="navbar navbar-expand-lg">
							<a class="navbar-brand" href="{{ route('website.index') }}">
								<img src="{{ asset('images/logoBlanco.svg')}}" alt="Logo">
							</a>
    ...
    <body>
                    ...
                    <div class="inner-content">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <p class="copyright-text">© 2024 VERONICA AGUILAR BEAUTY STUDIO- Todos los derechos
                                    reservados</p>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <div class="single-footer f-about">
                                        ...
                                        <ul class="social">
                                            ...
                                            <li><a href="https://www.instagram.com/veronica_aguilar_bs/"><i
        ...
        <script defer src="{{ asset('js/v84a3a4012de94ce1a686ba8c167c359c1696973893317.js')}}"></script>
